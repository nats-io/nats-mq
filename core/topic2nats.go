...
func NewTopic2NATSConnector(bridge *BridgeServer, config ConnectorConfig) Connector {
...
func (mq *Topic2NATSConnector) Stats() *stats.ConnectorStats {
	mq.Lock()
	defer mq.Unlock()
...
func (mq *Topic2NATSConnector) Config() ConnectorConfig {
	return mq.config
}
